...
# ONNX Runtime setup
onnx_default_path = os.getenv('ONNX_ROOT', 'C:\\onnxruntime\\onnxruntime-win-x64-gpu-1.20.1') # replace hard coded path '/home/skooter500/onnxruntime-linux-x64-1.20.1'
